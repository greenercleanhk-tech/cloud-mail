const zh = {
    ...
    emptyOldPwdMsg: '请输入旧密码',
    pwdChangeSuccessMsg: '密码修改成功，请重新登录',
    add: '添加',
    manage: '管理',
    rename: '改名',
    delete: '删除',
    ...
    scheduleDetail: '任務詳情',
    sendTemplate: '模板',
    dailyLimitLabel: '日發上限',
    overallProgress: '總進度',
    sentCount: '已發',
    failedCount: '失敗',
    remaining: '剩餘',
    mailboxProgress: '郵箱發送進度',
    currentMailbox: '當前郵箱',
    poolIndex: 'Pool索引',
    lastSentDate: '最後發送日',
    ...
    status: '狀態',
    customDomain: '自訂網域',
    customDomainPlaceholder: '如 mail.parkin.hk，Cloudflare Workers 自訂網域',
    dailyLimit: '每日發件上限',
    dailyLimitUnit: '封/天',

    // ---------- 退訂頁 ----------
    unsubscribeProcessing: '正在處理退訂…',
    unsubscribeSuccess: '✅ 退訂成功',
    unsubscribeSuccessDesc: '您已成功退訂營銷郵件。<br>您不會再收到我們的推廣郵件。',
    unsubscribeFailed: '❌ 退訂失敗',
    unsubscribeFailedDesc: '請稍後再試，或聯繫我們。',
    unsubscribeInvalid: '⚠️ 無效連結',
    unsubscribeInvalidDesc: '退訂連結無效，請聯繫我們。',
    retry: '重試',
}
export default zh
