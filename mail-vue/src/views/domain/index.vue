<template>
  <div class="domain-container">
    ...
    <el-table :data="domainList" stripe style="width: 100%" v-loading="loading">
      ...
      <el-table-column :label="$t('mailboxCount')" min-width="80" align="center">
        <template #default="{ row }">
          <el-tag type="info" size="small">{{ row.mailboxCount ?? 0 }}</el-tag>
        </template>
      </el-table-column>

      <el-table-column :label="$t('activeJobCount')" min-width="80" align="center">
        <template #default="{ row }">
      ...
      <el-table-column :label="$t('completedJobCount')" min-width="80" align="center">
        <template #default="{ row }">
